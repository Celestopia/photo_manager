...
- Displaying photos and video covers through one image surface with stable library-scoped resource URLs, bounded adjacent preloading, and a decoded-frame handoff to video playback.
