...
test('session usage sums completion attempts once and marks missing reports', () => {
  const messages = [{role:'user'}, {role:'assistant',attempt:{steps:[{kind:'completion',usage:{inputTotal:10,output:3,inputCacheHit:0,inputCacheMiss:10}}]}}, {role:'assistant',attempt:{retryOf:'prior',steps:[{kind:'completion',usage:{inputTotal:20,output:5,inputCacheHit:null,inputCacheMiss:null}}]}}];
