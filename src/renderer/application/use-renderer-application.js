...
export function useRendererApplication() {
    ...
    const locationContext = {
      ...
      getLocationTreeLabel,
      openLocationDropdown, closeLocationDropdown,
      setLocationForTarget, clearLocationForTarget,
      openCreateLocationMenu, closeCreateLocationMenu, createLocationAndSelect,
      setCreateLocationParent, openLocationManager,
      closeLocationManager, startLocationEdit, cancelLocationEdit,
      setEditLocationParent, saveLocationEdit,
      deleteLocationGlobally,
    };
    ...
    const viewerContext = {
      ...
      cancelViewerTransition, saveAndContinueViewerTransition, discardAndContinueViewerTransition,
      toggleFullscreen, buildImageUrl, contextCopyFile, contextCopyPath, contextCopyJson,
      ...
      onAudioLoadedMetadata, onAudioPlaybackError, onVideoVolumeChange,
